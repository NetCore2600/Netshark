...
[
    ...
    if test "$GCC" = yes ; then
	    ...
	    # NETSHARK_API will be visible outside (shared) libraries.
	    #
...
AC_DEFUN(AC_LBL_SHLIBS_INIT,
    ...
    if test "$GCC" = yes ; then
	    ...
	    hpux*)
		    ...
		    # we don't add them in netshark-config.
		    #
		    ;;
...
#
AC_DEFUN(AC_NETSHARK_C___ATOMICS,
    [
...
dnl   network, such as rnetshark servers.
dnl
